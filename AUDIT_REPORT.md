...
```27:30:electron/services/scheduler.service.ts
...
#### `optimizeSchedule` naming
`optimizeSchedule()` is identical to `generateSchedule()` — same pipeline, same rebalance. The name overpromises relative to actual capability.
